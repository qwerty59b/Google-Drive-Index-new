...
// using tailwind css
// npx tailwindcss -i ./src/tailwind.css -o ./tailwindoutput.css --watch
...
const OS = {
  ...
  isMacLike: /(Mac|iPhone|iPod|iPad)/i.test(userAgent),
  isiOS: /(iPhone|iPod|iPad)/i.test(userAgent),
  isMobile: /Android|webOS|iPhone|iPad|iPod|iOS|BlackBerry|IEMobile|Opera Mini/i.test(userAgent)
};
